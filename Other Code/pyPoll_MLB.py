...
file_to_load = os.path.join("Resources", "MLB_CSV_Data.csv")
# Assign a variable to save the file to a path.
file_to_save = os.path.join("analysis", "all_star_ballot_analysis.txt")
...
with open(file_to_save, "w") as txt_file:
    ...
    county_summary = (
        f"\n"
        f"-------------------------\n"
        f"Team with most votes: {county_turnout_name}\n"
        f"-------------------------\n"
        f"\n")
    ...
    winning_candidate_summary = (
        f"\n"
        f"-------------------------\n"
        f"Player with most votes: {winning_candidate}\n"
        f"Highest Vote Count: {winning_count:,}\n"
        f"Highest Percentage: {winning_percentage:.1f}%\n"
        f"-------------------------\n")
